...
export default function Onboarding() {
  ...
  // Define total steps for candidate onboarding
  const totalSteps = 3; // steps 0, 1, 2 = 3 steps total
    ...
    <div className="max-w-7xl mx-auto px-4 pt-6 space-y-8">
      ...
      <Form {...form}>
        <form
          ...
          {/* Update NextStep to use the same totalSteps */}
          <NextStep step={step} setStep={setStep} totalSteps={totalSteps - 1} />
        </form>
      </Form>
    </div>
  );

...
//       // Company Profile
//       name: "",
//       email: localStorage.getItem("user_email") || "", // Pre-populate with user email
//       phone: "",
//       about: "",
//       website: "",
//       address: "",
...
//       const companyData = {
//         name: data.name || "",
//         email: data.email.trim(), // Use email from form
//         phone: data.phone || "",
//         about: data.about || "",
//         website: formatUrl(data.website), // Use helper function
//         address: data.address || "",
//         city: data.city || "",
//         state: data.state || "",
//         country: data.country.trim(), // Use country from form
//         postal_code: data.postal_code || "",
//         size_min: data.size_min || 1,
//         size_max: data.size_max || 50,
//         industry_code: data.industry_code || "",
//         linkedin_url: formatUrl(data.linkedin_url), // Use helper function
//         twitter_url: formatUrl(data.twitter_url), // Use helper function
//       };
      
//       console.log("Sending company data:", companyData);
      
//       // Make the API call with proper headers to avoid 412 error
//       const response = await axios.post(
//         'https://appealing-perception-production.up.railway.app/api/employers/company',
//         companyData,
//         {
//           headers: {
...
// hooks/forms/use-employer-onboarding-form.ts
import axios from "axios";
import { useState } from "react";
import { useForm } from "react-hook-form";
import { useNavigate } from "react-router";

...
//         <ul className="space-y-4 list-disc list-inside">
//           {yearsOfExperience && <li>{yearsOfExperience} Years of Experience</li>}
//           {education && <li>Education: {education}</li>}
...
//               className="px-0 h-11"
//               onClick={(e) => {
//                 e.preventDefault(); // don't navigate to details when downloading
...
//             </Button>
//           ) : (
//             <Button variant="link" className="px-0 h-11 text-muted-foreground" disabled>
...
export default function CandidateCard({
  ...
  return (
    <Link to={`/employers/candidates/${id}`}>
      <div
        className={cn(
          "space-y-4 lg:space-y-6 px-4 p-4 lg:py-6 border rounded-[6px]",
          aiRecommended && "bg-[#F8F8FD]",

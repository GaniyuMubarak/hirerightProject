...
//   return useQuery({
//     queryKey: ["employer-candidates"],
//     queryFn: () => CandidateServices.getEmployerCandidates(),
//   });
// }
...
//               All {total > 0 ? `(${total})` : ""}
// =======
//               All {candidates.length ? `(${candidates.length})` : ""}
// >>>>>>> Stashed changes
//             </TabsTrigger>
...
//                       id={candidate.id}
//                       fullName={
//                         candidate.user?.full_name ?? candidate.full_name ?? "—"
//                       }
//                       jobTitle={
//                         candidate.user?.job_title ?? candidate.job_title
//                       }
//                       avatarUrl={
//                         candidate.user?.profile_image_url ??
//                         candidate.profile_image_url
//                       }
//                       yearsOfExperience={candidate.years_of_experience}
//                       education={candidate.education_level}
//                       appliedAt={candidate.applied_at ?? candidate.created_at}
